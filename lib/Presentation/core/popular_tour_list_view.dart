...
class ToursListView extends StatefulWidget {
  // const ToursListView({Key key}) : super(key: key);
      ...
      child: BlocBuilder<FeaturesBloc, FeaturesState>(
        builder: (context, state) {
          if (state is FeaturesOperationFailure) {
            return Text("Could Not Load Tours");
          }
          ...
          child: Transform(
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                //     .add(LoadReviews(tour.tourId));

                Navigator.of(context)
                    .pushNamed(TourInfoScreen.routeName, arguments: tour);
              },
              child: SizedBox(
                height: 280,
                child: Stack(
